        ...
        <section class="products content__centering">
            ...
            <div class="products__cards">
                <div class="product__card" v-for="good in goods" :key="good.id_product">
                    ...
                    <a href="#" class="product__add__link" @click="addToCart" :data-id="good.id_product"
                       :data-product-name="good.product_name" :data-price="good.price" :data-image="good.product_image">
                        <svg class="product__cart__svg" width="27"
    ...
    export default {
        ...
        methods: {
            addToCart() {
                ...
                const item = {
                    id_product: 123,
                    //id_product: parseInt(e.target.getAttribute('data-id')),
                ...
                axios.post(`${this.url}addToBasket.json`, item,
            ...
            async fetchGoods() {
                ...
                if (responce.ok) {
                    ...
                    this.goods[0].product_image = '/images/notebook.jpg';
                    this.goods[1].product_image = '/images/mouse.jpg';
                    //console.log(this.goods);
                } else {
...
<style>
    * {
    ...
    .offer__picture__block__1 {
        background-image: url("../../public/images/offer_1.jpg");
    }

    .offer__picture__block__2 {
        background-image: url("../../public/images/offer_2.jpg");
    }

    .offer__picture__block__3 {
        background-image: url("../../public/images/offer_3.jpg");
    }
    ...
    .offer__picture__2 {
        ...
        -ms-flex-pack: center;
        justify-content: center;
        background-image: url("../../public/images/offer_4.jpg");
    }
